      ...
      <Navbar variant="light" expand="lg" className='container'>
        ...
        <Navbar.Collapse id="basic-navbar-nav" className=' '>
          <Nav className="nav-link justify-content-around w-100">
            ...
            <Link className='nav-link' to="/about">Hướng dẫn mua hàng</Link>
            <Link className='nav-link' to="/about">Hình thức thanh toán</Link>
            <Link className='nav-link' to="/top">Top Nạp</Link>
            <Link className='nav-link' to={"https://www.facebook.com/profile.php?id=100012829152690"}>Hỗ Trợ</Link>
          </Nav>
        </Navbar.Collapse>
      </Navbar >
    </NavigatorWrapper >
